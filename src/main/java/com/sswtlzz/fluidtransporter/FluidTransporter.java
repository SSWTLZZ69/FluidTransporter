...
public class FluidTransporter {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "fluid_transporter" namespace
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "fluid_transporter" namespace
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MODID);
    // Create a Deferred Register to hold CreativeModeTabs which will all be registered under the "examplemod" namespace
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, MODID);

    // Creates a new Block with the id "fluid_transporter:example_block", combining the namespace and path
    ...
    public static final RegistryObject<CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("fluid_transporter", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                output.accept(FLUID_TRANSPORTER_ITEM.get()); // Add the example item to the tab. For your own tabs, this method is preferred over the event
            }).build());
